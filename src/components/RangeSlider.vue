<template>
    <div class="range-slider">
        <div class="range-slider__input">
            <input v-model="activeValue" :min="min" :max="max" type="number" />
        </div>
        <input class="range-slider__main" type="range" :min="min" :max="max" :step="step" :value="activeValue" ref="slider" @change="handleChange" />
    </div>
</template>
<script>
export default {
